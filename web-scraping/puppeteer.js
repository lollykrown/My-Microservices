                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://lollykrown.xyz" target="_blank">Call To Action</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Lollykrown inc. Gbagada, Lagos, Nigeria</span>
                    <br> Don't like these emails? <a href="http://i.imgur.com/CScmqnj.gif">Unsubscribe</a>.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="http://lollykrown.xyz">HTMLemail</a>.
                  </td>
                </tr>
              </table>
            </div>
...
`
    ...
    //   waityntil waits until all css, js imgs files are loaded
    //   await page.goto('https://carmalou.com', {waitUntil: "networkidle2"});
    ...
    // await page.goto("https://github.com/lollykrown?tab=repositories", {
    ...
    // await page.keyboard.type(plateNo)
    // await page.click(button)

    // let spanRes = []
    // let vehicleMake, vehicleColor;
    //  const spans = document.querySelectorAll('span');
    //  await page.waitForSelector(spans)
    //   await Array.from(spans).map((span) => {
    //     spanRes.push(span.innerText)
    //   });
